...
Route::group(['prefix' => 'admin', 'middleware' => 'admin'], function () {
    ...
    Route::get('/shops', 'AdminController@shops')->name('admin.shops');
    Route::get('/shops/pending-acceptance', 'AdminController@pendingAcceptance')->name('admin.pendingAcceptance');
    Route::get('/restaurants/pending-acceptance/accept/{id}', 'AdminController@acceptRestaurant')->name('admin.acceptRestaurant');
    Route::get('/shops/searchShops', 'AdminController@searchShops')->name('admin.post.searchShops');
    Route::get('/shops/edit/{id}', 'AdminController@getEditShops')->name('admin.get.editShops');
    ...
    Route::post('/shop/edit/save', 'AdminController@updateShop')->name('admin.updateShop');
    Route::post('/shop/new/save', 'AdminController@saveNewShop')->name('admin.saveNewShop');
    Route::post('/restaurant/bulk/save', 'BulkUploadController@restaurantBulkUpload')->name('admin.restaurantBulkUpload');
    Route::get('/shop/{restaurant_id}/items', 'AdminController@getShopItems')->name('admin.getShopItems');
