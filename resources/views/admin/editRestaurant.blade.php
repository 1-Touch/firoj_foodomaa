...
<div class="content">
    <div class="col-md-8">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('admin.updateShop') }}" method="POST" enctype="multipart/form-data">
                    <legend class="font-weight-semibold text-uppercase font-size-sm">
                        <i class="icon-address-book mr-2"></i> Shops Details
                    </legend>
                    ...
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label">Shop Categories: </label>
                        <div class="col-lg-9">
