    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse" id="navbar-navigation">
            <ul class="navbar-nav">
                @role("Admin")
               <!--  <li class="nav-item">
                    <a href="{{ route("admin.locations") }}" class="navbar-nav-link {{ Request::is('admin/locations') ? 'active' : '' }}">
                    <i class="icon-store2 mr-2"></i>
                    Locations
                    </a>
                </li> -->
                <li class="nav-item">
                    <a href="{{ route("admin.shops") }}" class="navbar-nav-link {{ Request::is('admin/shops') ? 'active' : '' }}">
                    <i class="icon-store2 mr-2"></i>
                    Shops
                    </a>
                </li>
